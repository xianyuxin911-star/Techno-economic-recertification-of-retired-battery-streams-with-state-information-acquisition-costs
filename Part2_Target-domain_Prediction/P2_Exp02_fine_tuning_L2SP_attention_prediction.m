...
cfg = struct( ...
    ...
    'pred_csv', fullfile(output_results_dir, 'P2_Exp02_FineTuneL2SP_PackPredictions.csv'), ...
    'attn_csv', fullfile(output_results_dir, 'P2_Exp02_FineTuneL2SP_CellAttention.csv'), ...
    'metrics_csv', fullfile(output_results_dir, 'P2_Exp02_FineTuneL2SP_Metrics.csv'), ...
    'result_mat', fullfile(output_results_dir, 'P2_Exp02_FineTuneL2SP_Results.mat'), ...
    'M', 512, ...
    'nCell', 45, ...
    'maxEpochs', 60, ...
    'warmupEpochs', 20, ...
