...
The script reuses the k-dependent decision losses, optimized thresholds, action allocations, and executed pathway values generated by `P5_Exp01`. It does not rerun the residual model or the threshold-grid search.
