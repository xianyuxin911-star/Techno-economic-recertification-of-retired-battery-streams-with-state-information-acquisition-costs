...
fig_lfp = plotPerPackBenchmark( ...
 LFP, ...
 'Extended Data Fig. 6e - LFP fixed-k additional cost per pack', ...
 marker_list, ...
 color_list, ...
 line_width, ...
 marker_size, ...
...
fig_nmc = plotPerPackBenchmark( ...
 NMC, ...
 'Extended Data Fig. 6f - NMC fixed-k additional cost per pack', ...
 marker_list, ...
 color_list, ...
 line_width, ...
 marker_size, ...
...
function fig = plotPerPackBenchmark( ...
 ...
 ylabel(ax, ...
    'Non-optimal policy additional cost (USD pack^{-1})', ...
 'FontName', 'Arial', ...
 'FontSize', 11);
